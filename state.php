...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
  <li class="breadcrumb-item"><a href="Home.php">Inicio</a><i class="fa fa-angle-right"></i>Configuración<i class="fa fa-angle-right"></i>Departamento</li>
</ol>
      ...
      <div class="vali-form-group">
          ...
          <div class="input-group">
            ...
            <select name="country" style="text-transform: capitalize; width: 250px;" required>
              ...
              <?php while ($rw = mysqli_fetch_assoc($countryn)) { ?>
                <option value="<?php echo $rw["CountryId"]; ?>" <?php if ($id == $rw["CountryId"]) {
                                                                  echo "selected";
        ...
        <div class="col-md-3 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" name="state" required="" value="<?php echo $name; ?>" placeholder="Nombre Departamento" class="form-control" style="width: 250px; height: 35px; float: right;">
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
      <div class="col-md-12 form-group">
        <button type="submit" name="addstates" class="btn btn-primary">Agregar</button>
        <button type="reset" class="btn btn-default">Resetear Valores</button>
    ...
    <div style="height: 396px;">
      <div class="w3l-table-info">
        ...
        <form method="GET" action="#">
          ...
          <input style="float: right;" placeholder="Buscar..." type="search-box" name="searcstate" value="<?php echo (isset($_GET['searcstate'])) ? $_GET['searcstate'] : ""; ?>"><br>
        </form>
        <table id="table">
          <thead>
            <tr>
              <th>Id</th>
              <th style="width: 5000px;">Nombre</th>
              <th style="text-align: center; width: 450px;">Acción</th>
            </tr>
          </thead>
          <tbody>
            <?php $i = 1;
