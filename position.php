...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
  <li class="breadcrumb-item"><a href="Home.php">Inicio</a><i class="fa fa-angle-right"></i>Configuración<i class="fa fa-angle-right"></i>Cargo</li>
</ol>
      ...
      <div class="vali-form-group">
        ...
        <div class="col-md-3 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" name="position" required="" value="<?php echo $name; ?>" placeholder="Nombre Cargo" class="form-control" style="width: 250px; height: 35px; float: right;">
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
      <div class="col-md-12 form-group">
        <button type="submit" name="positionl" class="btn btn-primary">Agregar</button>
