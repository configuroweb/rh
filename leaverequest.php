...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
  <li class="breadcrumb-item"><a href="Home.php">Inicio</a><i class="fa fa-angle-right"></i>Permiso<i class="fa fa-angle-right"></i>Permisos</li>
</ol>
<form method="POST">
  ...
  <div class="validation-form" style="margin-bottom: 0px;margin-top: 10px;">
    ...
    <?php $i = 1;
    while ($row = mysqli_fetch_assoc($laccept)) {
  ...
  <div class="validation-form" style="margin-bottom: 30px;margin-top: 10px;">
    ...
    <?php $i = 1;
    while ($row = mysqli_fetch_assoc($ldenied)) {
      $name = ucfirst($row['FirstName'] . " " . $row['LastName']);
    ?>
      <div class="row" style="margin-right: 0; margin-left: 0;">
        <div class="col-md-1">
