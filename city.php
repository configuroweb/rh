...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
  <li class="breadcrumb-item"><a href="Home.php">Inicio</a><i class="fa fa-angle-right"></i>Configuración<i class="fa fa-angle-right"></i>Ciudad</li>
</ol>
      ...
      <div class="vali-form-group">
          ...
          <div class="input-group">
            ...
            <select name="state" style="text-transform: capitalize; width: 250px;" required>
              ...
              <?php while ($rw = mysqli_fetch_assoc($staten)) { ?>
                <option value="<?php echo $rw["StateId"]; ?>" <?php if ($id == $rw["StateId"]) {
                                                                echo "Selected";
        ...
        <div class="col-md-3 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" name="city" placeholder="Nombre de Ciudad" value="<?php echo $name; ?>" required="" class="form-control" style="width: 250px; height: 35px;">
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
      <div class="col-md-12 form-group">
        <button type="submit" name="cityy" class="btn btn-primary">Agregar</button>
    ...
    <div style="height: 396px;">
      <div class="w3l-table-info">
        ...
        <form method="GET" action="#">
          ...
          <input style="float: right;" placeholder="Buscar" type="search-box" name="searccity" value="<?php echo (isset($_GET['searccity'])) ? $_GET['searccity'] : ""; ?>"><br>
        </form>
        <table id="table">
          <thead>
            <tr>
