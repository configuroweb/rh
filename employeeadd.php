...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
  <li class="breadcrumb-item"><a href="Home.php">Inicio</a><i class="fa fa-angle-right"></i>Empleado<i class="fa fa-angle-right"></i> Agregar Empleado</li>
</ol>
<!--grid-->
    ...
    <form method="POST" action="controller/employee.php?empedit=<?php echo isset($_GET['empid']) ? $_GET['empid'] : ''; ?>" enctype="multipart/form-data">
      ...
      <div class="vali-form-group">
        <div class="col-md-4 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" name="empid" title="Employee ID" value="<?php echo (isset($editemp["EmployeeId"])) ? $editemp["EmployeeId"] : ""; ?>" class="form-control" placeholder="ID de Empleado" required="">
          </div>
        </div>
      ...
      <div class="vali-form-group">
        <div class="col-md-4 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" name="fname" title="First Name" value="<?php echo (isset($editemp["FirstName"])) ? $editemp["FirstName"] : ""; ?>" class="form-control" placeholder="Nombre" required="">
          </div>
        </div>

        <div class="col-md-4 control-label">
          <label class="control-label">Segudo Nombre*</label>
          <div class="input-group">
            <span class="input-group-addon">
              <i class="fa fa-user" aria-hidden="true"></i>
            </span>
            <input type="text" name="mname" title="Middel Name" value="<?php echo (isset($editemp["MiddleName"])) ? $editemp["MiddleName"] : ""; ?>" class="form-control" placeholder="Segundo Nombre" required="">
          </div>
        </div>
        ...
        <div class="col-md-4 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" name="lname" title="Last Name" value="<?php echo (isset($editemp["LastName"])) ? $editemp["LastName"] : ""; ?>" class="form-control" placeholder="Apellido" required="">
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
      ...
      <div class="vali-form-group">
        <div class="col-md-4 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" id="Birthdate" title="Birth Date" name="bdate" placeholder="Fecha de Nacimiento" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<?php echo (isset($editemp["Birthdate"])) ? $editemp["Birthdate"] : ""; ?>" class="form-control" required="">
          </div>
        </div>
        ...
        <div class="col-md-4 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" name="mnumber" title="Mobile Number" value="<?php echo (isset($editemp["Mobile"])) ? $editemp["Mobile"] : ""; ?>" class="form-control" placeholder="Móvil" min="10" maxlength="10" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required="">
          </div>
        </div>
      ...
      <div class="col-md-12 control-label">
        ...
        <div class="input-group">
          ...
          <input type="text" name="address1" title="Address 1" value="<?php echo (isset($editemp["Address1"])) ? $editemp["Address1"] : ""; ?>" class="form-control" placeholder="Dirección" required="">
        </div>
      </div>
      <div class="clearfix"> </div>
      ...
      <div class="col-md-12 control-label">
        ...
        <div class="input-group">
          ...
          <input type="text" name="address2" title="Address 2" value="<?php echo (isset($editemp["Address2"])) ? $editemp["Address2"] : ""; ?>" class="form-control" placeholder="Dirección 2" required="">
        </div>
      </div>
      <div class="clearfix"> </div>
      <div class="col-md-12 control-label">
        <label class="control-label">Dirección 3</label>
        <div class="input-group">
          <span class="input-group-addon">
            <i class="fa fa-pencil " aria-hidden="true"></i>
          </span>
          <input type="text" name="address3" title="Address 3" value="<?php echo (isset($editemp["Address3"])) ? $editemp["Address3"] : ""; ?>" class="form-control" placeholder="Dirección 3">
        </div>
      </div>
      <div class="clearfix"> </div>
      ...
      <div class="vali-form-group">
        <div class="col-md-3 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" id="JoinDate" title="Join Date" name="joindate" placeholder="Fecha Ingreso" value="<?php echo (isset($editemp["JoinDate"])) ? $editemp["JoinDate"] : ""; ?>" class="form-control" required="" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
          </div>
        </div>
        ...
        <div class="col-md-3 control-label">
          ...
          <div class="input-group">
            ...
            <input type="text" id="LeaveDate" title="Leave Date" name="leavedate" placeholder="Fecha Salida" value="<?php echo (isset($editemp["LeaveDate"])) ? $editemp["LeaveDate"] : ""; ?>" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
          </div>
        </div>
          ...
          <div class="input-group">
            ...
            <select name="role" required="" title="Role" style="text-transform: capitalize;">
              ...
              <?php while ($rw = mysqli_fetch_assoc($rolen)) { ?>
                <option value="<?php echo $rw["RoleId"]; ?>" <?php if (isset($editemp["RoleId"]) && $editemp["RoleId"] == $rw["RoleId"]) {
                                                                echo "Selected";
                                                              } ?>> <?php echo $rw["Name"]; ?> </option>
              <?php } ?>
            </select>
      ...
      <div class="vali-form-group">
        ...
        <div class="col-md-3 control-label">
          ...
          <div class="input-group">
            ...
            <input type="email" name="email" title="Email" value="<?php echo (isset($editemp["Email"])) ? $editemp["Email"] : ""; ?>" class="form-control" placeholder="Correo" required="">
          </div>
        </div>
        ...
        <div class="col-md-3 control-label">
          ...
          <div class="input-group">
            ...
            <input type="password" id="Psw" title="Password" value="<?php echo (isset($editemp["Password"])) ? $editemp["Password"] : ""; ?>" name="password" placeholder="Contraseña " class="form-control" required="">
            <span class="input-group-addon">
