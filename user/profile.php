	...
	<div class="s-12 l-2">
		<table>
			<tbody>
				...
				<tr>
					<td align="center"><b>ID empleado:</b> <?php echo (isset($_SESSION['User']['EmployeeId'])) ? $_SESSION['User']['EmployeeId'] : "Null"; ?></td>
				</tr>
			</tbody>
		</table>
	</div>
	<div class="s-12 l-4">
		<table>
			<tbody>
				...
				<tr>
					<td style="text-align: right;"><b>Dirección 2:</b></td>
				...
				<tr>
					<td style="text-align: right;"><b>Ciudad Departamento:</b></td>
