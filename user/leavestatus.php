...
?>
<div class="s-12 l-10">
	<h1 style="color: #858282;">Solicitudes de Permisos</h1>
	<hr>
	...
	<div class="s-12 l-2">
		<h4 style="background: #858282; color: white; text-align: center;">Estado</h4>
	</div>
	<div class="s-12 l-3">
		<h4 style="background: #858282; color: white; text-align: center;">Motivo</h4>
	</div>
	<div class="s-12 l-2">
		<h4 style="background: #858282; color: white; text-align: center;">Fecha Inicio</h4>
	</div>
	<div class="s-12 l-2">
		<h4 style="background: #858282; color: white; text-align: center;">Fecha Fin</h4>
	</div>
	<div class="s-12 l-1">
		<h4 style="background: #858282; color: white; text-align: center;">Estado</h4>
	</div>
	<div class="s-12 l-1">
		<h4 style="background: #858282; color: white; text-align: center; border-radius: 0px 4px 4px 0px;">Acción</h4>
	</div>

	<?php $i = 1;
	while ($rom = mysqli_fetch_assoc($leavedetails)) { //print_r($rom);exit;
		...
		<div class="s-12 l-1" style="text-align: center;"><?php $i = $i;
															echo $i;
															$i++; ?></div>
